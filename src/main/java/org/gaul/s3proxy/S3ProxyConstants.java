...
public final class S3ProxyConstants {
	...
	public static final String PROPERTY_CORS_EXPOSED_HEADERS = "s3proxy.cors-exposed-headers";
	...
	/**
	 * Configure servicing of virtual host buckets. Setting to localhost:8080 allows
	 * bucket-in-hostname requests, e.g., bucketname.localhost:8080. This mode
	 * requires configuring DNS to forward all requests to the S3Proxy host.
	 */
	...
	/**
	 * Used to locate blobstores by specified bucket names. Each property file
	 * should contain a list of buckets associated with it, e.g.
	 * s3proxy.bucket-locator.1 = data s3proxy.bucket-locator.2 = metadata
	 * s3proxy.bucket-locator.3 = other When a request is made for the specified
	 * bucket, the backend defined in that properties file is used. This allows
	 * using the same credentials in multiple properties file and select the backend
	 * based on the bucket names.
	 */
	...
	/**
	 * Minimum delay, in seconds, when propagating modifications from the write
	 * backend to the read backend.
	 */
	...
	public static final String PROPERTY_STORAGE_CLASS_BLOBSTORE = "s3proxy.storage-class-blobstore";
	...
	public static final String PROPERTY_USER_METADATA_REPLACER = "s3proxy.user-metadata-replacer-blobstore";
	public static final String PROPERTY_USER_METADATA_REPLACER_FROM_CHARS = "s3proxy.user-metadata-replacer-blobstore.from-chars";
	public static final String PROPERTY_USER_METADATA_REPLACER_TO_CHARS = "s3proxy.user-metadata-replacer-blobstore.to-chars";
